...
int StreamImageWriter::WriteRawHeader(RAWCodec* inCodec, std::ostream* inStream){
  ...
  const int theBufferSize = 4*sizeof(uint16_t)+sizeof(uint32_t)+2*sizeof(uint16_t)+sizeof(uint32_t)+2*sizeof(uint16_t)+sizeof(uint32_t);
...
//  std::streamoff theOffset;
  ...
  // memcpy(&(tmpBuffer1[6*sizeof(uint16_t)+sizeof(uint32_t)]), &sizeTag, sizeof(uint32_t));
    ...
    memcpy(&(tmpBuffer1[6*sizeof(uint16_t)+2*sizeof(uint32_t)]), &ninthTag, sizeof(uint16_t)); //fffe
    memcpy(&(tmpBuffer1[7*sizeof(uint16_t)+2*sizeof(uint32_t)]), &tenthTag, sizeof(uint16_t)); //e000

    memcpy(&(tmpBuffer1[8*sizeof(uint16_t)+ 2*sizeof(uint32_t)]), &sizeTag, sizeof(uint32_t));//Item Length

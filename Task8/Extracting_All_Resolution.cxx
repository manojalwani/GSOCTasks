 ...
 //  w.SetCheckFileMetaInformation( true );
  ...
  if (flag == 1)
  {
     ...
     *rfn++ = row;
     ...
     gdcm::DataElement di( gdcm::Tag(0x0048, 0x0201) );
     di.SetByteValue(rfn, 1);
     di.SetVR( gdcm::VR::US );
    
    gdcm::DataElement di1( gdcm::Tag(0x0048, 0x0202) );
     di1.SetByteValue(rfn, 1);
     di1.SetVR( gdcm::VR::US );
